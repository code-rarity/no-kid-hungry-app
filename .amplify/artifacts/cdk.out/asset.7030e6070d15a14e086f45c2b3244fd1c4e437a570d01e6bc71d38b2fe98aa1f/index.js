    ...
    var AmplifyError = class _AmplifyError extends Error {
      ...
      static fromStderr = (_stderr) => {
        ...
        if (serialized && serialized.length === 4) {
          try {
            const serializedString = serialized.slice(1).find((item) => item && item.length > 0)?.replaceAll('\\"', '"').replaceAll("\\'", "'");
            if (!serializedString) {
              return void 0;
            }
...
var require_lib2 = __commonJS({
  "node_modules/@aws-amplify/platform-core/lib/index.js"(exports2) {
    ...
    Object.defineProperty(exports2, "__esModule", { value: true });
    exports2.TagName = exports2.CDKContextKey = exports2.USAGE_DATA_TRACKING_ENABLED = void 0;
